...
import de.vectordata.skynet.net.jvsl.filetransfer.Identifier;
import de.vectordata.skynet.net.jvsl.filetransfer.StreamMode;
...
import de.vectordata.skynet.net.jvsl.packet.length.VariableLength;
