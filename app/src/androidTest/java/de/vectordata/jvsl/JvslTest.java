...
public class JvslTest {
    ...
    private void testTransfer(VSLClient client) throws IOException {
        String file = "/storage/emulated/0/Download/260663710.webp";
        ContentAlgorithm algo = ContentAlgorithm.NONE;
        FTEventArgs args = new FTEventArgs(new Identifier(0), new FileMeta(file, algo,null, null, null), file);
